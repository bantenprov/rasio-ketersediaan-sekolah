    ...
    methods: {
        ...
        onSubmit: function() {
            if (this.formstate.$invalid) {
              ...
              {
                axios.post("/rk-sekolah-sd-mi/store", {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/rk-sekolah-sd-mi/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/rk-sekolah-sd-mi/create'
                  }
                },
                window.location.href = '#/admin/rk-sekolah-sd-mi/create')
        ...
        back() {
            window.location = '#/admin/rk-sekolah-sd-mi';
        }
    },
    mounted: function() {
        axios.get("/rk-sekolah-sd-mi/create").then(response => {
